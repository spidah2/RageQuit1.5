...
const GAME_CONFIG = {
    ...
    // Indexed by spell type: 1=Missile, 2=Begone, 3=Fireball, 4=Impale, 5=Arrow, 6=Melee, 7=Whirlwind, 8=Heal
    SPELL_COSTS: {
        1: 5,    // MISSILE
        2: 15,   // BEGONE
        3: 20,   // FIREBALL
    ...
    // Time in seconds to charge before casting
    SPELL_CAST_TIMES: {
    ...
    SPELL_PARAMS: {
        ...
        PUSH_UP_FORCE: 300,            // Alias for BEGONE_FORCE_VERTICAL
        FIREBALL_UP_FORCE: 600,        // Alias for FIREBALL_FORCE_VERTICAL
        
        // ===== ALIASES FOR PHYSICS CONSTANTS =====
        PUSH_FORCE: 900,               // Alias for BEGONE_FORCE_HORIZONTAL
    ...
    PHYSICS: {
        ...
        MISSILE_GRAVITY: 80,            // Gravity for missiles
        PUSH_SPEED: 700,                // Shockwave projectile speed
        PUSH_GRAVITY: 300,              // Gravity for push spell
        FIREBALL_SPEED: 500,            // Fireball projectile speed
        FIREBALL_GRAVITY: 600,          // Gravity for fireball
